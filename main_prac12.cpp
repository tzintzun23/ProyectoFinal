...
void carrusel()
{
	...
	glAlphaFunc(GL_GREATER, 0.1); //PORCENTAJE DE OPACIDAD
	glTranslatef(-15, 0.1, 30);
	fig1.prisma(0.1, 22, 22, base_m.GLindex);
	glPopMatrix();
	//BASE GIRATORIA
	glPushMatrix();
	glEnable(GL_ALPHA_TEST);
	glAlphaFunc(GL_GREATER, 0.1); //PORCENTAJE DE OPACIDAD
	glTranslatef(-15, 0.2, 30);
	glRotatef(carrus, 0, 1, 0);
	fig1.cilindro(10, 0.5, 50, base_g.GLindex);
	//CENTRO CILINDRO
	glPushMatrix();
	glEnable(GL_ALPHA_TEST);
	glAlphaFunc(GL_GREATER, 0.1); //PORCENTAJE DE OPACIDAD
	glTranslatef(0, 0.5, 0);
	fig1.cilindro(2, 10, 50, dorado.GLindex);
	glPopMatrix();
	//TECHO
	glPushMatrix();
	glEnable(GL_ALPHA_TEST);
	glAlphaFunc(GL_GREATER, 0.1); //PORCENTAJE DE OPACIDAD
	glTranslatef(0, 10, 0);
	fig1.cono(10, 12, 60, techo_carru.GLindex);
	glPushMatrix();
	glTranslatef(0, 11, 0);
	fig1.esfera(1, 20, 20, esfera.GLindex);
	glPopMatrix();
	glPopMatrix();
	//BASES DE CABALLOS
	glPushMatrix();
	...
	fig1.cilindro(0.3, 10, 50, cilind.GLindex);
	glPopMatrix();
	...
	glAlphaFunc(GL_GREATER, 0.1); //PORCENTAJE DE OPACIDAD
	glTranslatef(0, 0, 7);
	fig1.cilindro(0.2, 10, 50, cilind.GLindex);
	glPopMatrix();
...
void MRusa()
{
	...
	fig1.prisma(2, 40, 20, techo_carru.GLindex);
	//BASE 2
	glPushMatrix();
	glTranslatef(0, 1, 0);
	fig1.prisma(3, 35, 15, techo_carru.GLindex);
	//BASE 3
	glPushMatrix();
	glTranslatef(0, 1, 0);
	fig1.prisma(3, 30, 12, techo_carru.GLindex);
	//BASE4
	glPushMatrix();
	glTranslatef(0, 1, 0);
	fig1.prisma(4, 25, 11, techo_carru.GLindex);
	glPopMatrix();
	glPopMatrix();
	glPopMatrix();
	glPopMatrix();
...
void ciudad ()
{
		...
		glPushMatrix(); //Camino3  lateral derecho (abajo)
		glTranslatef(11.5, 0.0, 31);
		glRotatef(90, 0, 1, 0);
		//glScalef(40,0.1,7);
		glScalef(55, 0.1, 7);
